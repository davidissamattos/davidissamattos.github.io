...
Create a new post
`hugo new post/2025/my-new-post.md`

Create a new music post content
`hugo new music/my-score.md`

Test Hugo using a local webserver
...
* A music archetype is created and we have a hook in layouts
* Layouts also define the partials for the head to load it
